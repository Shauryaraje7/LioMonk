  ...
  const cards = [
    {
      ...
      points: ["AI Chatbots", "Machine Learning", "Process Automation", "Data Analytics"],
      img: defaultImg,
      direction: "left",
    },
    {
      ...
      points: ["Lead Management", "Workflow Automation", "Customer Insights", "Sales Dashboard"],
      img: defaultImg,
      direction: "left",
    },
    {
      ...
      points: ["End-to-End Development", "Project Management", "Quality Assurance", "Deployment"],
      img: defaultImg,
      direction: "right",
    },
    {
      ...
      points: ["Responsive Design", "SEO Optimization", "Fast Performance", "Modern UI/UX"],
      img: defaultImg,
      direction: "right",
    },
    {
      ...
      points: ["Cloud Migration", "CI/CD Pipelines", "Monitoring", "DevOps Automation"],
      img: defaultImg,
      direction: "middle",
    },
    {
  ...
  return (
    <section ref={sectionRef} className="digital-section">
      <div className="digital-inner">
        ...
        {/* Subtitle */}
        <p className={`digital-subtitle ${isVisible ? "subtitle-visible" : ""}`}>
          From concept to deployment, we deliver cutting-edge digital solutions that
          drive growth and transform businesses through innovative technology.
        </p>
